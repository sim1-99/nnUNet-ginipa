...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        self.disable_default_data_aug = False
        self.do_ginipa_data_aug = False
    ...
    def get_dataloaders(self):
        ...
        disable_default_data_aug = self.disable_default_data_aug
        do_ginipa_data_aug = self.do_ginipa_data_aug
        ...
        tr_transforms = self.get_training_transforms(
            patch_size, disable_default_data_aug, rotation_for_DA, deep_supervision_scales,
            mirror_axes, do_dummy_2d_data_aug, do_ginipa_data_aug,
